...
<div class="row" style="padding: 10px">
    ...
    <div class="col-md-9">
        ...
        <div>
            <p><a style="color:green; float: right;margin-right: 20px"href="<c:url value="/admin/orders"/>">Trở về trang danh sách bài đăng</a></p>
        </div>
    </div>
</div>
            ...
            <table class="table">
                ...
                <c:forEach var="b" items="${booking}">
                    <tr>
                        ...
                        <c:if test="${b[5] == false}">
                            <td>
                                <a href="javascript:;" class="btn btn-danger" style="font-size: 15px" onclick="deleteBooking(${b[0]})">Từ chối</a>
                            </td>
                        </c:if>


                        <c:if test="${b[5] == false && b[7].trangThaiDonHang == 'DANG_DAU_GIA'}">
                            <td>
                                <a href="javascript:;" class="btn btn-success" style="font-size: 15px" onclick="xacnhanbooking(${b[0]})">Xác nhận đấu giá</a>
                            </td>
                        </c:if>

                        <c:if test="${b[7].trangThaiDonHang != 'DANG_DAU_GIA'}">
                            <td>
                                <p class="text text-danger text-left" style="font-size: 15px;font-style: italic">Đã có shipper giao đơn hàng này</p>
                            </td>
                        </c:if>
